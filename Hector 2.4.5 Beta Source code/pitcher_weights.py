section_weights = {
    "meta": {
        ...
        "core_potentials": 1.0,
        "pitch_arsenal": 0.5,
        "pitch_arsenal_potential": 0.5,  # NEW meta multiplier for pitch potentials
    ...
    "other_attributes": {
        "number_of_pitches": 0.15,    # Bonus for pitchers who throw a variety of pitches
        "velocity": 0.0,             # Weight for average pitch velocity
        "stamina": 0.02,             # Pitcher's endurance
        "ground_fly_ratio": 0.01,    # Favor ground ball pitchers
...
# However, this is not recommended because it may unfairly lower ratings of quality players who have limited scouting data (e.g., IFAs).
    ...
    "penalties": {
        ...
        "penalty_sp_low_control_potential": -0.3, # Penalty only to SP who have below 50 Control Potential
