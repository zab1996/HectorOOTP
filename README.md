...
You can also **Try without building OOTP views:** download [hector-sample-exports.zip](https://github.com/zab1996/HectorOOTP/releases/download/3.0.0/hector-sample-exports.zip) (Player List + Draft Class + Team List HTML), unzip, and upload those files on the live site.

To run the app yourself offline, grab **hector-3.0-web.zip** from the [3.0.0 release](https://github.com/zab1996/HectorOOTP/releases/tag/3.0.0).
...
This is an AI coded project and has been since v1, many changes have been made throughout the various versions but yeah its still AI slop. Hope you find it interesting still anyways!
