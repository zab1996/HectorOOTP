...
BUTTON_TOOLTIPS = {
    "top_batters_by_pos": (
        ...
        "Results are grouped by position and respond instantly to your search bar, age filters (e.g. '<25', '>=21'), or position selections.\n"
    ...
    "top_pitchers_by_pos": (
        ...
        "Results are grouped by SP/RP and update instantly with your search bar, age filters (e.g. '<26'), or position selections.\n"
